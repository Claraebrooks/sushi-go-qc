#!/usr/bin/env python3
"""
Sushi Go — Ultimate Monte Carlo Bot
Based on: https://github.com/atomicobject/sushi-go-starter-kit

Usage:
    python sushi_go_client.py localhost 7878 <game_id> <n>
    python sushi_go_client.py <game_id> <n>          # defaults localhost:7878

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
COMPETITIVE UPGRADES OVER STANDARD MONTE CARLO
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

1. HIGHER SIMULATIONS (1000)
   More rollouts = more accurate EV estimates = fewer mistakes on
   close decisions. Biggest gains on turn 1 when many cards are live.

2. RELATIVE SCORING  (scores[us] - best_opponent * DENIAL_WEIGHT)
   Vanilla MC maximises your score. This maximises your LEAD.
   Makes the bot actively block opponents who are about to score big
   (e.g. opponent has 2 sashimi → taking the 3rd denies them 10 pts).

3. HEURISTIC ROLLOUTS  (opponents play smart, not random)
   Random opponents make terrible decisions, making EV estimates
   unrealistic. We simulate opponents using the same heuristic weights
   as our own strategy — so simulated games look like real ones.

4. OPPONENT MODELLING  (infer opponent needs from their table)
   Track every card each opponent has played. In rollouts, weight their
   simulated picks toward cards they demonstrably need (e.g. opponent
   with 2 Sashimi will be simulated seeking a 3rd, not playing randomly).

5. ROTATION TRACKING  (count cards seen; infer what's in each hand)
   We know the full deck (108 cards). We track every card seen so far.
   The remaining pool is deck − seen − our_hand. Opponent hands are
   sampled from this realistic pool, not a naive full-deck estimate.
   Also tracks which cards have been seen N times, capping impossible draws.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
STRATEGY BY PLAYER COUNT  (auto-detected, no config needed)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
2p — Denial + Pudding Control   pudding=2.0, denial on, skip maki_1
3p — Balanced Opportunist       all weights moderate, sets viable
4p — Dumplings + Guaranteed     dumpling=1.5, maki deprioritised
5p — Nigiri Sprint              avoid slow sets, wasabi=1.6, tiny hands
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
"""
